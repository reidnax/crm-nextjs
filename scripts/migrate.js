...
async function checkDatabase() {
  try {
    await execCommand('npx prisma db pull --force', 'Database connection check');
    return true;
  } catch (error) {
...
async function runSeeding() {
  try {
    await execCommand('npx tsx src/lib/permissions/seed-permissions.ts', 'Permission system seeding');
    return true;
  } catch (error) {
